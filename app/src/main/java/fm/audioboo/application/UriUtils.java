...
//      }
    ...
    /**
     * Create an fm.audioboo-schemed URI for opening a Boo's details page.
     **/
    ...
    public static Uri createDetailsUri(int id, boolean message) {
        return Uri.parse(String.format(Locale.US, "fm.audioboo:///boo_details?id=%d&message=%d",
                id, message ? 1 : 0));
    }


    /**
     * Create an fm.audioboo-schemed URI for recording to a destination user or
     * channel.
     **/
    ...
    public static Uri createRecordUri(int destination_id, String destination_name,
        ...
        String uri = null;
        try {
            uri = String.format(Locale.US, "fm.audioboo:///record_to?destination_name=%s&",
