...
public class API {
    ...
    private static final String DEFAULT_API_HOST = "api.fm.audioboo.fm";
    ...
    private static final String SRV_LOOKUP_FORMAT = "_%s._audioboo._tcp.fm.audioboo.fm.";
    // private static final String DEFAULT_API_HOST            = "api.staging.fm.audioboo.fm";
    ...
    static {
        ...
        for (String API_BOO_URL : API_BOO_URLS) {
            REQUEST_TYPES.put(API_BOO_URL, RT_GET);
        }
    ...
    public void fetchBooDetails(int booId, final Handler result_handler, final boolean isMessage) {
        String api = null;
        ...
        scheduleRequest(new Request(api, null, signedParams, msg -> {
     ...
     **/
    public void fetchBoos(final int type, final Handler result_handler, int page, int amount, Date timestamp) {
        // Honor pagination
     ...
     **/
    void fetchContacts(final Handler result_handler) {
    ...
    public String getSignedLinkUrl() {
        HashMap<String, Object> signedParams = new HashMap<String, Object>();
        signedParams.put("callback[success]", "fm.audioboo:///link_success");
        signedParams.put("callback[cancelled]", "fm.audioboo:///link_cancelled");
        signedParams.put("callback[failure]", "fm.audioboo:///link_failure");
